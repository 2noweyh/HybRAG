...
# python data_preprocess/dgl_extractor_v2.py --dataset webqsp
...
def main():
    ...
    torch.save(dic, f'./data/{args.dataset}/{args.dataset}_dic_graph_new.pt')
    print(f"  - Saved split DIC graph dict: ./data/{args.dataset}_dic_graph.pt")
